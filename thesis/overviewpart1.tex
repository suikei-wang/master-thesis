...
$$
\par Solution for general multiple non-linear equality constraints is discussed in the chapter of deep declarative network nodes. Here, we give a simple example of non-linear equality constrained optimization problem. 
...
$$
\par Consequently, we have $x = \pm \frac{y}{\|y\|_{2}}$. For each $x$, we can compute its corresponding value of the objective function:
$$
...
x = -\frac{y}{\|y\|_{2}}, -x^{T} y=\|y\|_{2}
$$ 
\par Obviously, the minimum is achieved with $f = -\|y\|_{2}$ at $x = \frac{y}{\|y\|_{2}}$. 
