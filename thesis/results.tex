...
\end{equation}
From the Equation above, we get the step size
\begin{equation}
...
\begin{figure}[t]
    ...
    \centering
    \includegraphics[page=1, width=.8\textwidth]{figs/conjugate-gradient.pdf}
...
\end{equation}
\par Combining the result of the linear system in Equation~\ref{equ:pre-conj-linear-sys} and the conjugate gradient method, we get this transformed conjugate gradient method~\citep{SJ:94}. The choice of the preconditioner 
